        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_1.5fr_1fr] gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">Lifestyle Expert</span>
              <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded-full">Fat Loss Expert</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/testimonials" className="text-muted-foreground hover:text-primary transition-colors text-sm">Testimonials</Link>
              <Link to="/contact" className="text-muted-foreground hover:text-primary transition-colors text-sm">Contact</Link>
              <Link to="/certificates" className="text-muted-foreground hover:text-primary transition-colors text-sm">My Certificates</Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <a 
                ...
                className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-sm whitespace-nowrap"
              >
              ...
              >
                ...
                <span>J-3A, Ground Floor, Vikas Puri, New Delhi, 110018</span>
              </a>
              {/* Social Icons */}
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/disclaimer" className="text-muted-foreground hover:text-primary transition-colors text-sm">Disclaimer</Link>
      ...
      <div className="border-t border-border">
        <div className="container mx-auto px-4 py-4">
          <p className="text-center text-sm text-muted-foreground">
            © 2026 Health Studio By Geeta Angra | All rights reserved
          </p>
        </div>
      </div>
    </footer>
